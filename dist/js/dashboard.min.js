...
function KonfettiApi(n,t){var o="http://localhost:9000/konfetti/api",i="http://fourcores2016.cloudapp.net:9000/konfetti/api",a="https://konfetti-prod.testserver.de/konfetti/api",e=i;if(0==window.location.href.indexOf("http://localhost")?(alert("auto set to localhost"),e=o):alert("RUNNING PROD"),0!=a.indexOf("https"))return alert("SECURITY EXCEPTION: PRODUCTION API NEEDS TO RUN ON HTTPS !!"),{};var u="",c=function(n){if(""!=u)return void n();var o=t.open({animation:!0,backdrop:"static",template:'<div style="width: 200px;margin: 12px;">Backend Admin Password: (as set in API config) <input ng-model="password" type="password" style="margin-top: 10px;" onkeypress="(window.event.charCode==13)?document.getElementById(\'login\').click():void(0);"/><button ng-click="setPassword(password)" id="login" type="button" class="btn btn-primary btn-md" style="margin-top:12px;">Login</button></div>',size:"sm",controller:["$scope",function(t){t.password="",t.setPassword=function(t){""!=t&&(u=t,o.close(),n())}}]})},r=function(n,o){var i=t.open({animation:!0,template:'<div style="width: 280px; margin: 12px;padding: 8px;">'+n+'<br><button ng-click="close()" type="button" class="btn btn-primary btn-md" style="margin-top:12px;">OK</button></div>',size:"sm",controller:["$scope",function(n){n.close=function(n){i.close(),"undefined"!=typeof o&&o()}}]})},f=function(){var n={timeout:6e3,cache:!1,headers:{"X-ADMIN-PASSWORD":u+""}};return n},d=function(n){return"undefined"!=typeof n&&null!=n&&"undefined"!=typeof n.data&&null!=n.data&&"undefined"!=typeof n.data.message&&null!=n.data.message&&0==n.data.message.indexOf("FAIL-PASSWORD")&&(u="",!0)};return{isRunningDevelopmentServer:function(){return a!=e},loadDashBoardInfo:function(t,o){var i=function(t,o){var a=f();a.method="GET",a.url=e+"/party/dashboard";var u=function(n){t(n.data)},l=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){i(t,o)})}):o()};n(a).then(u,l)};c(function(){i(t,o)})},loadAllUsers:function(t,o){var i=function(t,o){var a=f();a.method="GET",a.url=e+"/account";var u=function(n){t(n.data)},l=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){i(t,o)})}):o()};n(a).then(u,l)};c(function(){i(t,o)})},loadAllParties:function(t,o){var i=function(t,o){var a=f();a.method="GET",a.url=e+"/party";var u=function(n){t(n.data)},l=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){i(t,o)})}):o()};n(a).then(u,l)};c(function(){i(t,o)})},loadParty:function(t,o,i){var a=function(o,i){var u=f();u.method="GET",u.url=e+"/party/"+t;var l=function(n){o(n.data)},s=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){a(o,i)})}):i()};n(u).then(l,s)};c(function(){a(o,i)})},createParty:function(t,o,i){var a=function(o,i){var u=f();u.method="POST",u.url=e+"/party",u.data=t;var l=function(n){o(n.data)},s=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){a(o,i)})}):i()};n(u).then(l,s)};c(function(){a(o,i)})},generateKonfetti:function(t,o,i,a,u){var l=function(a,u){var s=f();s.method="GET",s.url=e+"/account/coupons-admin/"+t+"?count="+o+"&amount="+i;var p=function(n){a(n.data)},v=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){l(a,u)})}):u()};n(s).then(p,v)};c(function(){l(a,u)})},generateCodes:function(t,o,i,a,u){var l=function(a,u){var s=f();s.method="GET",s.url=e+"/account/codes-admin/"+t+"?count="+o+"&type="+i;var p=function(n){a(n.data)},v=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){l(a,u)})}):u()};n(s).then(p,v)};c(function(){l(a,u)})},updateParty:function(t,o,i){var a=function(o,i){var u=f();u.method="PUT",u.url=e+"/party",u.data=t;var l=function(n){o(n.data)},s=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){a(o,i)})}):i()};n(u).then(l,s)};c(function(){a(o,i)})},deleteParty:function(t,o,i){var a=function(o,i){var u=f();u.method="DELETE",u.url=e+"/party/"+t.id;var l=function(n){o()},s=function(n){d(n)?r("PASSWORD IS WRONG",function(){c(function(){a(o,i)})}):i()};n(u).then(l,s)};c(function(){a(o,i)})},modalAlert:function(n,t){r(n,t)},logout:function(){u=""}}}angular.module("RDash").factory("KonfettiApi",["$http","$uibModal",KonfettiApi]);