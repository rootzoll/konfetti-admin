...
function KonfettiApi(n,t){var o="http://fourcores2016.cloudapp.net:8280/konfetti/api",i="https://konfetti-prod.testserver.de/konfetti/api",a=o;if(0==window.location.href.indexOf("http://localhost"),0!=i.indexOf("https"))return alert("SECURITY EXCEPTION: PRODUCTION API NEEDS TO RUN ON HTTPS !!"),{};var e="",u=function(n){if(""!=e)return void n();var o=t.open({animation:!0,backdrop:"static",template:'<div style="width: 200px;margin: 12px;">Backend Admin Password: (as set in API config) <input ng-model="password" type="password" style="margin-top: 10px;" onkeypress="(window.event.charCode==13)?document.getElementById(\'login\').click():void(0);"/><button ng-click="setPassword(password)" id="login" type="button" class="btn btn-primary btn-md" style="margin-top:12px;">Login</button></div>',size:"sm",controller:["$scope",function(t){t.password="",t.setPassword=function(t){""!=t&&(e=t,o.close(),n())}}]})},c=function(n,o){var i=t.open({animation:!0,template:'<div style="width: 280px; margin: 12px;padding: 8px;">'+n+'<br><button ng-click="close()" type="button" class="btn btn-primary btn-md" style="margin-top:12px;">OK</button></div>',size:"sm",controller:["$scope",function(n){n.close=function(n){i.close(),"undefined"!=typeof o&&o()}}]})},r=function(){var n={timeout:6e3,cache:!1,headers:{"X-ADMIN-PASSWORD":e+""}};return n},f=function(n){return"undefined"!=typeof n&&null!=n&&"undefined"!=typeof n.data&&null!=n.data&&"undefined"!=typeof n.data.message&&null!=n.data.message&&0==n.data.message.indexOf("FAIL-PASSWORD")&&(e="",!0)};return{isRunningDevelopmentServer:function(){return i!=a},loadDashBoardInfo:function(t,o){var i=function(t,o){var e=r();e.method="GET",e.url=a+"/party/dashboard";var d=function(n){t(n.data)},l=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){i(t,o)})}):o()};n(e).then(d,l)};u(function(){i(t,o)})},loadAllUsers:function(t,o){var i=function(t,o){var e=r();e.method="GET",e.url=a+"/account";var d=function(n){t(n.data)},l=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){i(t,o)})}):o()};n(e).then(d,l)};u(function(){i(t,o)})},loadAllParties:function(t,o){var i=function(t,o){var e=r();e.method="GET",e.url=a+"/party/all";var d=function(n){t(n.data)},l=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){i(t,o)})}):o()};n(e).then(d,l)};u(function(){i(t,o)})},loadParty:function(t,o,i){var e=function(o,i){var d=r();d.method="GET",d.url=a+"/party/"+t;var l=function(n){o(n.data)},s=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){e(o,i)})}):i()};n(d).then(l,s)};u(function(){e(o,i)})},createParty:function(t,o,i){var e=function(o,i){var d=r();d.method="POST",d.url=a+"/party",d.data=t;var l=function(n){o(n.data)},s=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){e(o,i)})}):i()};n(d).then(l,s)};u(function(){e(o,i)})},generateKonfetti:function(t,o,i,e,d){var l=function(e,d){var s=r();s.method="GET",s.url=a+"/account/coupons-admin/"+t+"?count="+o+"&amount="+i;var p=function(n){e(n.data)},v=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){l(e,d)})}):d()};n(s).then(p,v)};u(function(){l(e,d)})},generateCodes:function(t,o,i,e,d){var l=function(e,d){var s=r();s.method="GET",s.url=a+"/account/codes-admin/"+t+"?count="+o+"&type="+i;var p=function(n){e(n.data)},v=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){l(e,d)})}):d()};n(s).then(p,v)};u(function(){l(e,d)})},updateParty:function(t,o,i){var e=function(o,i){var d=r();d.method="PUT",d.url=a+"/party",d.data=t;var l=function(n){o(n.data)},s=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){e(o,i)})}):i()};n(d).then(l,s)};u(function(){e(o,i)})},deleteParty:function(t,o,i){var e=function(o,i){var d=r();d.method="DELETE",d.url=a+"/party/"+t.id;var l=function(n){o()},s=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){e(o,i)})}):i()};n(d).then(l,s)};u(function(){e(o,i)})},deleteUser:function(t,o,i){var e=function(o,i){var d=r();d.method="DELETE",d.url=a+"/account/"+t;var l=function(n){o()},s=function(n){f(n)?c("PASSWORD IS WRONG",function(){u(function(){e(o,i)})}):i()};n(d).then(l,s)};u(function(){e(o,i)})},modalAlert:function(n,t){c(n,t)},logout:function(){e=""}}}angular.module("RDash").factory("KonfettiApi",["$http","$uibModal",KonfettiApi]);